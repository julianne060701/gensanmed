...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('pharmpurch.purchase.store') }}" method="POST" enctype="multipart/form-data" id="poForm">
                @csrf
                ...
                <div class="form-row align-items-center mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="po_number" class="form-control" placeholder="Enter PO Number" required>
                    </div>
                </div>
