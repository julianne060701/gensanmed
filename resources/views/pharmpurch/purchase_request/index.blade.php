...
<div class="container-fluid">
    <div class="d-flex justify-content-end mb-3">
        <a href="{{ route('pharmpurch.purchase_request.create') }}" class="btn btn-primary px-5">Upload PR</a>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    @php
                        ...
                        $config = [
                            'data' => $data,
                            'order' => [[8, 'desc']], // Sort by the 'Date Created' column in descending order
...
$(document).on('click', '.view-purchase', function() { 
    ...
    $.get('{{ url("pharmpurch/purchase_request") }}/' + purchaseId, function(data) {
